...
<div class="container-fluid breadcrumb">
  <div class="row">
    <div class="col-md-7">
      <p>HOME. DIGITAL ADVERTISEMENT</p>
      <h1> DIGITAL ADVERTISEMENT</h1>
    </div>
    <div class="col-md-5">
...
<div class="container busy-banner1" style="margin-top: -100px; margin-bottom: 100px;">
   <center>
    <img src="img/digi-banner.png" alt="" width="80%">
   </center>
</div>

<div class="container affiliate">
  <center>
    <h6>WHY INVEST IN DIGITAL ADVERTISEMENT</h6>
    <h5 style="font-size: 16px !important; line-height: 2;">El-Chári Invests In Electronic Billboard Marketing To Help Large Businesses And
      <br>Smes Reach A Wider Audience And Generate More Profit.</h5>
  </center>
</div>

<div class="container-fluid biz-abt1" style="padding-left: 70px; padding-right: 70px;">
  <div class="row">
    <div class="col-md-6">
      <div class="row">
        <div class="col-md-1">
      ...
      <div class="col-md-11">
        <h5>LARGE MARKET</h5>
      <h6>Millions Of Small And Medium Enterprises
        (Smes) In Nigeria Rely On Word-Of-Mouth
        Advertising Only. They Struggle With Profits
        Because Their Reach Is Limited. Digital
        Billboard Advertising Links Business
        Owners To Thousands Of Nigerians Passing
        The Busiest Roads Daily.</h6>
      </div>
      </div>
    </div>
    <div class="col-md-6">
      ...
      <div class="col-md-11">
        <h5>INCOME OPPORTUNITES</h5>
      <h6>Business Owners Invest More In Digital
        Billboard Advertising Because It Is Easier To
        Monitor Analytics And Understand Buyers’
        Behavior. This Creates Unlimited Income
...
<div class="container-fluid biz-abt2">
  <div class="row">
    <div class="col-md-6">
      <h5>EL-CHARI’S DIGITAL ADVERTISEMENT BUSINESS</h5>
      <h6>El-Chári Is Involved In Digital Billboard Advertising
        To Give Business Owners Maximum Reach.
        We Buy Digital Advert Boards Placed In Strategic
        Positions In Lagos State To Get More Eyes On
        Investors' Products And Services 24/7.</h6>
      <p>The Company Makes Profits When Business Owners Then Pay For
        Adverts On These Digital Billboards For A Certain Period. </p>
      <a href="#" class="btn btn-primary">INVEST WITH US <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
    <div class="col-md-6">
      <div class="row">
        <div class="col-md-12 real-img" style="margin-left: 50px;margin-top: -100px;">
          <img src="./img/digiads2.png" alt="" width="80%">
        </div>
    </div>
    </div>
  </div>
