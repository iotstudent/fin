...
<body>
  ...
  <div class="container-fluid" style="padding: 0px 50px;">
    <nav class="navbar">
      <div class="logo"><a href="index.html"> <img src="./img/logo.png" style="width: 150px;" alt=""></a></div>
      ...
      <ul>
        <li><a href="about.html">About Us</a></li>
          <li><a href="business.html">Our Businesses</a></li>
          <li><a href="invest.html">Investments</a></li>
          <li><a href="affiliate.html">Affiliates</a></li>
          <li><a href="academy.html">Academy</a></li>
          <li><a href="contact.html">Contact Us</a></li>
          <li class="cta-button"><a class="btn btn-secondary" href="login.html">Login</a></li>
      </ul>
    </nav>
  </div>
...
<div class="container profile" style="margin-top: 70px;">
  <div class="row">
    <div class="col-md-6" style="margin-top: 70px;">
      <img src="./img/Group1.png" alt="" width="100%">
    </div>
    <div class="col-md-6" style="margin-bottom: 70px;">
      <img src="./img/Group2.png" alt="" width="100%">
    </div>
    <br>
    <div class="col-md-6 pro-mob" style="margin-top: 70px;">
      <img src="./img/Group3.png" alt="" width="100%">
    </div>
    <div class="col-md-6" style="margin-bottom: 70px;">
      <img src="./img/Group4.png" alt="" width="100%">
    </div>
    <br>
    <div class="col-md-6 pro-mob" style="margin-top: 70px;">
      <img src="./img/Group5.png" alt="" width="100%">
    </div>
    <div class="col-md-6" style="margin-bottom: 70px;">
      <img src="./img/Group6.png" alt="" width="100%">
    </div>
    <div class="col-md-6 pro-mob" style="margin-top: 70px;">
      <img src="./img/Group7.png" alt="" width="100%">
    </div>
    <div class="col-md-6">
      <img src="./img/Group8.png" alt="" width="100%">
    </div>
  </div>
</div>


<div class="container-fluid pac-section6" data-aos="fade-up" data-aos-delay="100">
  <center>
    <h2>OUR VISION</h2>
    <h1>Our Vision Is To Be Recognized As A Successful And Leading
      Investment Company In The Provision Of High-Quality
      Services To Our Clients.</h1>
    <a class="btn btn-secondary" href="real-estate.html">GET STARTED <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
  </center>
</div>
...
<div class="container-fluid foot">
  <div class="row main-foot">
    <div class="col-md-4 col-sm-3">
      <a href="index.html"><img src="./img/logo.png" alt="" width="40%"></a>
      <br>
    ...
    <div class="col-md-4 col-sm-3 links1">
      ...
      <div class="row">
        <div class="col-md-6 links2">
          <nav>
            <ul>
              <a href="invest.html"><li>Investment</li></a>
              <a href="academy.html"><li>Trading academy</li></a>
              <a href="oil.html"><li>Oil & Gas</li></a>
              <a href="gold.html"><li>Gold exchange</li></a>
            </ul>
          </nav>
        </div>
        <div class="col-md-6 links3">
          <nav>
            <ul>
              ...
              <a href="digital-ads.html"><li>Digital advertisement</li></a>
              <a href="agric.html"><li>Agriculture</li></a> <br>
              <a href="affiliate.html"><li>Affiliates</li></a>
            </ul>
          </nav>
        </div>
    </div>
      ...
      <div class="col-lg-2 col-sm-6">
        ...
        <div class="footer-widget">
          ...
          <ul class="list-unstyled">
            <a href="real-estate.html"><li>Real estate</li></a>
              <a href="digital-ads.html"><li>Digital advertisement</li></a>
              <a href="agric.html"><li>Agriculture</li></a>
              <a href="affiliate.html"><li>Affiliates</li></a>
          </ul>
        </div>
      </div>
