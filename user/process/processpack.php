...
//create member from member page
    if(isset($_POST['create'])){
        ...
        $sql= "INSERT INTO package(name,capital,roi,duration,referal_bonus,roll_over)VALUES('$name','$capital','$roi','$duration','$rb','$ro')";
    ...
    if(isset($_POST['edit'])){
        ...
        $ro =  test_input($_POST["ro"]);
            ...
            $sql= "UPDATE package SET name='$name',capital='$capital',duration='$duration',roi='$roi',referal_bonus='$rb',roll_over='$ro' WHERE package_id = '$id' ";
