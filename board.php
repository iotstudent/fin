...
<div class="container-fluid breadcrumb">
  <div class="row">
    <div class="col-md-5">
      <p>HOME .ABOUT US. BOARD MEMBERS</p>
      <h1>ABOUT US</h1>
    </div>
    <div class="col-md-7">
...
<div class="container affiliate" style="margin-top: -50px;" data-aos="fade-up" data-aos-delay="100">
  <center>
    <h1>THE BOARD</h1>
    <h3 style="font-weight: 900; margin-top: -50px;">Our Financial Expertise</h3>
  </center>
</div>
...
<div class="container-fluid board">
  <div class="row">
    <div class="col-md-4" data-aos="fade-left" data-aos-delay="100">
        <img src="./img/abt1.png" alt="" width="100%">
        <div class="board-info shadow p-3 mb-5 bg-white rounded">
          <h3>ACHON DOMINIC</h3>
          <h5>Team Lead Brand By Polar</h5>
          <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
        </div>
    </div>
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <img src="./img/abt2.png" alt="" width="100%">
      <div class="board-info shadow p-3 mb-5 bg-white rounded">
        <h3>ADEDIJI MATTHEW MAYOWA</h3>
        <h5>Manager, Finance</h5>
        <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
      </div>
    </div>
    <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
      <img src="./img/abt3.png" alt="" width="100%">
      <div class="board-info shadow p-3 mb-5 bg-white rounded">
        <h3>ADESHINA OYENEYE</h3>
        <h5>DIRECTOR</h5>
        <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
      </div>
    </div>
    <div class="col-md-4" data-aos="fade-left" data-aos-delay="100">
      <img src="./img/abt4-1.png" alt="" width="100%">
      <div class="board-info shadow p-3 mb-5 bg-white rounded">
        <h3>ELUE, ERNEST U.T</h3>
        <h5>Banking</h5>
        <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
      </div>
  </div>
  <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
    <img src="./img/abt5-1.png" alt="" width="100%">
    <div class="board-info shadow p-3 mb-5 bg-white rounded">
      <h3>OLAYINKA EGBEDEYI</h3>
      <h5>Technology Consultant</h5>
      <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
  </div>
  <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
    <img src="./img/abt6.png" alt="" width="100%">
    <div class="board-info shadow p-3 mb-5 bg-white rounded">
      <h3>OLUFEMI BABAJIDE OLUMUYIWA</h3>
      <h5>Ammo Lube LTD (Director)</h5>
      <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
  </div><div class="col-md-4" data-aos="fade-left" data-aos-delay="100">
    <img src="./img/abt7.png" alt="" width="100%">
    <div class="board-info shadow p-3 mb-5 bg-white rounded">
      <h3>ALOFE AYODELE ALABA</h3>
      <h5>OIL AND GAS</h5>
      <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
</div>
<div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
  <img src="./img/abt8.png" alt="" width="100%">
  <div class="board-info shadow p-3 mb-5 bg-white rounded">
    <h3>OLUMIDE OPEYEMI ADUBI</h3>
    <h5>Legal Practitioner</h5>
    <a class="btn btn-primary" href="profile.php">VIEW PROFILE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
  </div>
</div>
<div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
