    ...
    <div class="container-fluid" style="margin-top: 0px;">
        <div class="row">
          ...
          <div class="col-md-6" style="margin-top: -50px; padding: 50px; background-color: #FEFEFF;" data-aos="fade-up" data-aos-delay="0">
            <form class="row g-3" id="contact3" action="user/process/processforgot.php" method="post">
            ...
            <div class="col-12" style="margin-top: -70px;">
                <center>
                    ...
                    <p style="color: #B4B4B4;">New to El-Chari? <a href="signup.php" style="color: red;">Sign up</a></p>
                </center>
            </div>
              <div class="col-12">
                <label for="inputEmail4" class="form-label">Your Email address</label>
