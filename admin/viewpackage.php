                                ...
                                <table id="bootstrap-data-table-export" class="table table-responsive table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ROI+Capital<small>(&#x20A6)</small></th>
                            ...
                            if($result = mysqli_query($conn,$sql)){ 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  $roi;?></td>
                                            <td><?php echo  $roi_capital;?></td>
                                            <td><?php echo  $duration;?></td>
                                            <td><?php echo  $rb;?></td>
                                            <td><?php echo  $ro;?></td>
                                            <td>
                                      <form action="editpackage.php" method='get' style="display: inline;">
                                            <input type='hidden'  name='packid' value="<?php echo $id; ?>" />
                                            <button type='submit' name='edit' class="btn btn-info" data-toggle="tooltip" title="Edit"/>Edit</button>
                                      </form>
                                    </td>
                                    <td>
                                      <form action="process/processpack.php" method='post' style="display: inline;">
                                            <input type='hidden'  name='packid' value="<?php echo $id; ?>" />
                                            <button type='submit' name='delete' class="btn btn-danger" data-toggle="tooltip" title="Delete"/>Delete</button>
                                      </form>
                                    </td>  
                                        </tr>
