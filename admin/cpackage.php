        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header"><strong>Create Package</strong></div>
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="company" placeholder="Enter Pacakage name" name="name" class="form-control">
                                </div>
                                <div class="form-group">
                                            <label for="capital" class=" form-control-label">Capital</label>
                                            <input type="number" id="street" placeholder="Capital" name="capital" class="form-control">
                                        </div>
                                    <div class="form-group">
                                        <label for="roi" class=" form-control-label">ROI (%)</label>
                                        <input type="number" step="0.1" id="vat" placeholder="ROI" class="form-control" name="roi">
                                    </div>

                                    <div class="form-group">
                                        <label for="roi" class=" form-control-label">ROI + Capital</label>
                                        <input type="number"  id="vat" placeholder="ROI+Capital" class="form-control" name="roi_capital">
                                    </div>
                                    <div class="form-group">
                                        <label for="duration" class=" form-control-label">Duration (months)</label>
                                        <input type="number" min=1 id="vat" placeholder="Duration" class="form-control" name="duration">
                                    </div>


                                    <div class="form-group">
                                        <label for="referal bonus" class=" form-control-label">Referal Bonus (%)</label>
                                        <input type="number" step="0.1" id="vat" placeholder="Referal Bonus" class="form-control" name="rb">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" name="create" value="Create" class="btn btn-success mb-2 mt-2" style="float:right;">
                                    </div>
                                </form>
                </div>
            </div><!-- .animated -->
