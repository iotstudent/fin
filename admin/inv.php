                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            $sql= " SELECT users.first_name,users.middle_name,users.last_name,investments.amount,investments.payment_date,investments.exp_date,investments.package FROM users JOIN investments ON users.user_id=investments.user_id ";
