...
<div class="container-fluid" style="padding-left: 70px; margin-top: 50px;">
  <div class="row pac2" id="pac2" data-aos="fade-up" data-aos-delay="100">
    <div class="col-sm-4 col-md-offset-1 packages1">
      <p>01</p>
      <h4>Oil And Gas</h4>
      ...
      <a class="btn btn-secondary" href="oil.php">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
    <div class="col-sm-4 col-md-offset-1 packages2">
      <p>02</p>
      <h4>Gold Exchange</h4>
      <hr align="left" style="width: 50px; border-bottom: 3px solid #0080FE;">
      <h6>Tap into the global oil industry generating
        an estimated revenue of $3.3 trillion annually.</h6>
        <a class="btn btn-secondary" href="gold.php">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
    <div class="col-sm-4 packages3">
      ...
      <h6>Tap into the global oil industry generating
        an estimated revenue of $3.3 trillion annually.</h6>
        <a class="btn btn-secondary" href="real-estate.php">READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
    <div class="col-sm-4 packages4">
      <p>04</p>
      <h4>Digital Advertisement</h4>
      <hr align="left" style="width: 50px; border-bottom: 3px solid #0080FE;">
      <h6>Tap into the global oil industry generating
        an estimated revenue of $3.3 trillion annually.</h6>
      <a class="btn btn-secondary" href="digital-ads.php"> READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
    <div class="col-sm-4 packages5">
      <p>05</p>
      <h4>Agriculture</h4>
      <hr align="left" style="width: 50px; border-bottom: 3px solid #0080FE;">
      <h6>Tap into the global oil industry generating
        an estimated revenue of $3.3 trillion annually.</h6>
      <a class="btn btn-secondary" href="agric.php"> READ MORE <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
    </div>
  </div>
</div>


<div class="container-fluid pac-section" style="margin-top: 100px; background-size: cover; height: 50vh;" id="pac-section" data-aos="fade-up" data-aos-delay="100">
  <center>
    <h2 style="font-size: 32px; padding: 50px;">Our Financial Advisors Determine The Right Businesses
      To Invest Your Money In, And You Watch It Rise Every
      Day.</h2>
